...
object NetworkModule {
    ...
    //private const val CHAT_BASE_URL = "https://therapist-ease-tonight-matched.trycloudflare.com/"
    private const val CHAT_BASE_URL = "http://192.168.1.200:8001"
    
    // 2. Firebase Emulators (Firebase SDK)
    // INCOLLA QUI I TUOI URL DI CLOUDFLARE (Senza https:// e senza slash finale)
    //private const val AUTH_HOST = "fabric-smell-jvc-incorporated.trycloudflare.com"      // Tunnel porta 9099

    private const val AUTH_HOST = "192.168.1.200"
    //private const val FIRESTORE_HOST = "acc-berkeley-voted-fleet.trycloudflare.com" // Tunnel porta 8080

    private const val FIRESTORE_HOST = "192.168.1.200"
